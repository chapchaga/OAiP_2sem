...
template <> constexpr inline auto Rectangle::qt_create_metaobjectdata<qt_meta_tag_ZN9RectangleE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<Rectangle, qt_meta_tag_ZN9RectangleE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject Rectangle::staticMetaObject = { {
    QMetaObject::SuperData::link<Shape::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN9RectangleE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN9RectangleE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN9RectangleE_t>.metaTypes,
    nullptr
} };
...
void *Rectangle::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN9RectangleE_t>.strings))

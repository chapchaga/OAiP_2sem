...
namespace {
struct qt_meta_tag_ZN6SquareE_t {};
} // unnamed namespace

template <> constexpr inline auto Square::qt_create_metaobjectdata<qt_meta_tag_ZN6SquareE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<Square, qt_meta_tag_ZN6SquareE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject Square::staticMetaObject = { {
    QMetaObject::SuperData::link<Rectangle::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN6SquareE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN6SquareE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN6SquareE_t>.metaTypes,
    nullptr
} };
...
void *Square::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN6SquareE_t>.strings))

...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_ellipse_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_ellipse_t qt_meta_stringdata_ellipse = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_ellipse[] = {
...
Q_CONSTINIT const QMetaObject ellipse::staticMetaObject = { {
    ...
    qt_meta_stringdata_ellipse.offsetsAndSizes,
    qt_meta_data_ellipse,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_ellipse_t,
        // Q_OBJECT / Q_GADGET

...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        tableDishes->setEditTriggers(QAbstractItemView::EditTrigger::NoEditTriggers);
        tableDishes->setSelectionBehavior(QAbstractItemView::SelectionBehavior::SelectRows);
        ...
        tableOrders->setEditTriggers(QAbstractItemView::EditTrigger::NoEditTriggers);
        tableOrders->setSelectionBehavior(QAbstractItemView::SelectionBehavior::SelectRows);
        ...
        tableAnalytics->setEditTriggers(QAbstractItemView::EditTrigger::NoEditTriggers);
        ...
        tableTests->setEditTriggers(QAbstractItemView::EditTrigger::NoEditTriggers);
